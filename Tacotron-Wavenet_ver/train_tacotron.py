...
def train(log_dir, config):
    ...
    with tf.variable_scope('datafeeder') as scope:
        ...
        train_feeder = DataFeederTacotron(coord, data_dirs, hparams, config, 8,data_type='train', batch_size=config.batch_size) #batch32 -> 8
...
def main():
    ...
    parser.add_argument('--data_paths', default='/home/jeon/Desktop/Speech_project/Tacotron-Wavenet-Vocoder/data/kss,/home/jeon/Desktop/Speech_project/Tacotron-Wavenet-Vocoder/data/son')
